...
def main():    
    ...
    A.add_connected_model(D)
    clock6 = Clock('Clock 6', TimeUnit.MS)
    clock6.configure_trigger_clock(2100)
    clock7 = Clock('Clock 7', TimeUnit.MS)
    clock7.configure_trigger_clock(4200)
    A.add_clock(clock6)
    D.add_clock(clock7)

    A.set_triggered_connection_priority(1)
    D.set_triggered_connection_priority(2)
    ...
    scheduler.configure_models_for_triggering()
    ...
    scheduler.generate_trigger_schedule()
