...
class Model:
    ...
    def __init__(self, model_name):
        ...
        self.__raster = -1
        self.__raster_modified = False
        self.__raster_modified_value = -1
        ...
        self.__connected_models = set()
        self.__triggered_connection_priority = -1
    ...
    def set_raster(self, raster, override = False):
        if override == True:
            self.__raster_modified_value = self.__raster
            self.__raster = raster
            self.__raster_modified = True
        else:
            self.__raster = raster
    ...
    def add_connected_model(self, model):
        self.__connected_models.add(model)

    def set_triggered_connection_priority(self, priority):
        self.__triggered_connection_priority = priority

    def get_triggered_connection_priority(self):
        return self.__triggered_connection_priority

    def is_trigger_based(self):
        for clock in self.__Clocks:
